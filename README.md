...
## Version 4.2 Release (31 March 2026)

Version 4.2 supersedes the planned 4.1 release, which was never finalized.
...
Improved the `prop-sorter` function that can be used to dump sets of state facts.

Fix code for computing `last-establishers` for facts.  This is useful in plan repair and in evaluating plans.

Also a number of small bug fixes and improvements.
